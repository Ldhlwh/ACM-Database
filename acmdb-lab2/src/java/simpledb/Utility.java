...
public class Utility {
     ...
     */
    public static HeapFile openHeapFile(int cols, File f) throws IOException
    {
    ...
    public static HeapFile openHeapFile(int cols, String colPrefix, File f) throws IOException
    {
        // create the HeapFile and add it to the catalog
